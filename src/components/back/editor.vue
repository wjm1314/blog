<template>
  <div class="wrapper">
    ...
    <div class="info">
      ...
      <textarea id="editor" spellcheck="false" v-if="isMarked" v-model="mdContent"
                @keydown.once.ctrl.13="saveDraft($route.query.aid)" v-focus>
      </textarea>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapMutations(['set_article','update_post_content','update_post_title','update_post_tags','set_dialog','isSaving_toggle']),
